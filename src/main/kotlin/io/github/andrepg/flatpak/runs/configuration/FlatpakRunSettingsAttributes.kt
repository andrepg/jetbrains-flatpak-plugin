...
class FlatpakRunSettingsAttributes : BaseOptions() {
    ...
    @get:Attribute("enableForceClean")
    var enableForceClean: Boolean by property(false)

    @get:Attribute("enableDeepClean")
    var enableDeepClean: Boolean by property(false)

    @get:Attribute("enablePortals")
    var enablePortals: Boolean by property(false)

    @get:Attribute("enableThemes")
    var enableThemes: Boolean by property(false)

    @get:Attribute("enableAudio")
    var enableAudio: Boolean by property(false)

    @get:Attribute("enableWayland")
    var enableWayland: Boolean by property(false)

    @get:Attribute("customArguments")
    var customArguments: String? by string("")
}
