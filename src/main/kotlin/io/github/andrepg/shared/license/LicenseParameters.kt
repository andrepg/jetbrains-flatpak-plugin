...
data object LicenseParameters {
    /** Licenses issued to a floating license server expire; stamps must be fresh. */
    const val timestampValidityPeriod: Long = 60 * 60 * 1000L // 1 hour long

    /**
     * Public root certificates needed to verify JetBrains-signed licenses.
     */
    val rootCertificates: List<String> = listOf(
        """
        -----BEGIN CERTIFICATE-----
